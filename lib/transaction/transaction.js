...
Transaction.prototype.checkedSerialize = Transaction.prototype.toString = function() {
  ...
  var result = this.uncheckedSerialize();
  if (result.length > BYTES_TO_HEXA_LENGTH * Transaction.MAX_TRANSACTION_SIZE) {
    throw new errors.Transaction.MaxTransactionSizeReached();
  }
  return result;
};
